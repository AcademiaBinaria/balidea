...
export class CalculatorService {
  ...
  public fromKilometersToMiles = (kilometers: number): number =>
    kilometers * this.milesPerKilometer

  public fromMilesToKilometers = (miles: number): number => miles * this.kilometersPerMile;

  public fromCelsiusToFahrenheit = (celsius: number): number =>
    celsius * this.factorC2F + this.boilingFahrenheit

  public fromFahrenheitToCelsius = (fahrenheit: number): number =>
    (fahrenheit - this.boilingFahrenheit) * this.factorF2C
}
